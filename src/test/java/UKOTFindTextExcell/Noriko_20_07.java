...
public class Noriko_20_07 {
    ...
    static String XLS = "/exel/UKBAUT392/data.xlsx";
...
//    static int n;
 ...
 try{for (int i = 0; i<30; i++){
     ...
     System.out.println("END of the LAND1");
     activityTest();
 }
 n=n+1;
        goToPage(TESTING_ROW + n, TESTING_URL_CELL); Thread.sleep(2000);
        driver.findElement(By.cssSelector("#truste-consent-button")).click();
        try{for (int i = 0; i<30; i++){
            scrollClick();}
        }catch (Exception e) {
            System.out.println("END of the LAND2");
            activityTest();
        }
        n=n+1;
        goToPage(TESTING_ROW + n, TESTING_URL_CELL); Thread.sleep(2000);
        ...
        try{for (int i = 0; i<30; i++){
            ...
            System.out.println("END of the LAND3");
            activityTest();
        }
        n=n+1;
        goToPage(TESTING_ROW + n, TESTING_URL_CELL); Thread.sleep(2000);
        ...
        try{for (int i = 0; i<30; i++){
            ...
            System.out.println("END of the LAND4");
            activityTest();
        }
        n=n+1;
        goToPage(TESTING_ROW + n, TESTING_URL_CELL); Thread.sleep(2000);
        ...
        try{for (int i = 0; i<30; i++){
            ...
            System.out.println("END of the LAN5");
            activityTest();
        }
        n=n+1;
        goToPage(TESTING_ROW + n, TESTING_URL_CELL); Thread.sleep(2000);
        ...
        try{for (int i = 0; i<30; i++){
            ...
            System.out.println("END of the LAND6");
            activityTest();
        }
        n=n+1;
        goToPage(TESTING_ROW + n, TESTING_URL_CELL); Thread.sleep(2000);
        ...
        try{for (int i = 0; i<30; i++){
            ...
            System.out.println("END of the LAND7");
            activityTest();
        }
        n=n+1;
//        for (int i = 0; i<23; i++){
