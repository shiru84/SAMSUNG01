...
public class UKOT558 {
    ...
    static String XLS = "/exel/UKOT558/data.xlsx";
...
//        expectedTEXT(TESTING_ROW + n, TESTING_DATA_CEL);
    ...
    public static void findExpectedText(int rowNum, int colNum) throws IOException, InterruptedException{
       ...
       try{
          WebElement meta = driver.findElement(By.cssSelector("body > app-root > cx-storefront > main > cx-page-layout > cx-page-slot.TokoRightContent.has-components.ng-star-inserted > cx-cart-totals > div > div > div > button"));
