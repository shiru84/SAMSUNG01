...
public class GBS21307002641 {
    ...
    static String XLS = "/exel/GBS21307002641/data.xlsx";
...
//    static int n;
    ...
    public static void activityTest() throws Exception {
        ...
        System.out.println(n);
        findExpectedText(TESTING_ROW + n, TEST_RESULT_CEL7);
        System.out.println(n);
        findExpectedText(TESTING_ROW + n, TEST_RESULT_CEL8);
        System.out.println(n);
        findExpectedText(TESTING_ROW + n, TEST_RESULT_CEL9);
        System.out.println(n);
        findExpectedText(TESTING_ROW + n, TEST_RESULT_CEL10);
        System.out.println(n);
