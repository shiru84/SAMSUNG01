...
public class GBS21307002672 {
    ...
    static String XLS = "/exel/GBS21307002672/data.xlsx";
...
quit();
    ...
    public static void findExpectedTextAndLink(int rowNum, int colNum) throws IOException, InterruptedException{
       ...
       try{
           ...
           System.out.println("Founud -  "+actualUrl);
           fis = new FileInputStream(FILE);
           workbook = new XSSFWorkbook(fis);
           sheet = workbook.getSheetAt(0);
           row = sheet.getRow(rowNum);
           row.createCell(colNum).setCellValue(meta_text);
           row.createCell(colNum+1).setCellValue(actualUrl);
