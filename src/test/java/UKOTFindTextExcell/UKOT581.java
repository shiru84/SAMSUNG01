...
public class UKOT581 {
    ...
    static String XLS = "/exel/UKOT581/data.xlsx";
...
//        }
    ...
    public static void findExpectedText(int rowNum, int colNum) throws IOException, InterruptedException{
       ...
       try{
          WebElement meta = driver.findElement(By.cssSelector("#wrap > div.slim-timer-bannerWrapper > div > div.slim-timer-mainCopy"));
