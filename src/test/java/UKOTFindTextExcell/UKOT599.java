...
public class UKOT599 {
    ...
    static String XLS = "/exel/UKOT599/data.xlsx";
...
//        }
    ...
    public static void findExpectedText(int rowNum, int colNum) throws IOException, InterruptedException{
       ...
       try{
          WebElement meta = driver.findElement(By.cssSelector("body > app-root > cx-storefront > main > cx-page-layout > cx-page-slot.TokoLeftContent.has-components.ng-star-inserted > cx-cart-details > div > cx-cart-item-list > div > div > cx-cart-item > div > div.cart-item__details > div.pzn-redemption.pzn-green"));
