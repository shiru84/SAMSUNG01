...
public class UKOT486 {
    ...
    static String XLS = "/exel/UKOT486/data.xlsx";
...
//         1 WebElement copy = driver.findElement(By.cssSelector("#wrap > div.seuk-samsung-week-countdown-timers--bannerWrapper > div > div.seuk-samsung-week-countdown-timers--right > div.seuk-samsung-week-countdown-timers--textCopy"));//description
           WebElement copy = driver.findElement(By.cssSelector("#wrap > div.seuk-samsung-week-countdown-timers--bannerWrapper > div > div.seuk-samsung-week-countdown-timers--right > div.seuk-samsung-week-countdown-timers--textCopy"));// keywords
//        String meta_text = driver.getTitle();
//           String meta_text = meta.getAttribute("href");
        String copy_text = copy.getText();

            System.out.println("Founud -  "+copy_text);
            fis = new FileInputStream(FILE);
            workbook = new XSSFWorkbook(fis);
            sheet = workbook.getSheetAt(0);
            row = sheet.getRow(rowNum);
            row.createCell(colNum).setCellValue(copy_text);
