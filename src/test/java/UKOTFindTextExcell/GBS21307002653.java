...
public class GBS21307002653 {
    ...
    static String XLS = "/exel/GBS21307002653/data.xlsx";
...
//test this sheet
        ...
        findExpectedTextAndLink(TESTING_ROW + n, TEST_RESULT_CEL5);
        System.out.println(n);Thread.sleep(1000);
        findExpectedText(TESTING_ROW + n, TEST_RESULT_CEL6);
        System.out.println(n);Thread.sleep(1000);
        findExpectedTextAndLink(TESTING_ROW + n, TEST_RESULT_CEL7);
        System.out.println(n);Thread.sleep(1000);
        findExpectedText(TESTING_ROW + n, TEST_RESULT_CEL8);
        System.out.println(n);Thread.sleep(1000);
        findExpectedTextAndLink(TESTING_ROW + n, TEST_RESULT_CEL9);
        System.out.println(n);Thread.sleep(1000);
        findExpectedText(TESTING_ROW + n, TEST_RESULT_CEL10);
        System.out.println(n);Thread.sleep(1000);
        findExpectedTextAndLink(TESTING_ROW + n, TEST_RESULT_CEL11);
        System.out.println(n);Thread.sleep(1000);
        quit();
        n = n + 1;
    }
