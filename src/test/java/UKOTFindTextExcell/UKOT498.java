...
public class UKOT498 {
    ...
    static String XLS = "/exel/UKOT498/data.xlsx";
...
//           WebElement meta = driver.findElement(By.cssSelector(" head > link:nth-child(7)"));
          WebElement meta = driver.findElement(By.cssSelector("body > app-root > cx-storefront > main > cx-page-layout > cx-page-slot.TokoLeftContent.has-components.ng-star-inserted > cx-cart-details > div > cx-cart-item-list > div > div > cx-cart-item > div > div.cart-item__details > div.pzn-redemption.pzn-green"));//description
