...
public class UKOT553 {
    ...
    static String XLS = "/exel/UKOT553/data.xlsx";
...
//
    ...
    public static void activityTest1() throws Exception {
        openBrowser();
        goToQaPage();

        findExpectedText(TESTING_ROW + n, TEST_RESULT_CEL2);
        Thread.sleep(1000);
        findExpectedText(TESTING_ROW + n, TEST_RESULT_CEL3);
        Thread.sleep(1000);
        findExpectedText(TESTING_ROW + n, TEST_RESULT_CEL4);
        System.out.println(n);
        findExpectedText(TESTING_ROW + n, TEST_RESULT_CEL6);
        System.out.println(n);
        driver.findElement(By.cssSelector("div.seuk-756--arrowWrapper > span.seuk-756--arrow")).click();
        Thread.sleep(1000);
    ...
    public static void activityTest2() throws Exception {
        openBrowser();
        goToQaPage();
    ...
    public static void goToQaPage() throws Exception {
    ...
    //      WebElement meta = driver.findElement(By.cssSelector("body > app-root > cx-storefront > main > cx-page-layout > cx-page-slot.TokoLeftContent.has-components.ng-star-inserted > cx-cart-details > div > div:nth-child(2) > div > div.pznAll-top > h2"));//description
