...
public class UKOT455 {
  ...
  static WebDriver driver;
    ...
    static String XLS = "/exel/UKOT455/data.xlsx";
    ...
    public static void findExpectedText(int rowNum, int colNum) throws IOException, InterruptedException{
        ...
        try{
            TEXT=driver.findElement(By.cssSelector("body > div.seuk-tv-neo-qled-cart-abandonment--caPopup > div > div.seuk-tv-neo-qled-cart-abandonment--caWrap > div.seuk-tv-neo-qled-cart-abandonment--caWrapReviews > p"));
